...
parser.add_argument('--glider', '-g', help='Glider registration or competition number')
...
parser.add_argument('--notask', '-n', action='store_true', help='Do not plot a task')
parser.add_argument('--maponly', action='store_true', help='Do not plot altitude graph')
...
plotflight(args.filename, pilot, args.glider, task, zoom=args.zoom, altitude = not args.maponly)