...
parser = argparse.ArgumentParser(description='Plot altitudes of all traces in a directory')
...
parser.add_argument('--imagefile', '-f', default=None, help='File to write A4 landscape plot into.  If not set, opens Matplotlib display.')
